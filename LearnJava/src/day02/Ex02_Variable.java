...
public class Ex02_Variable {
	...
	public static void main(String[] args) {
		...
		System.out.println(u.GREEN + "Varaiable Test" + u.END);
		u.p(u.BOLD + u.RED + "Variable Test" + u.END);
		
		// 1. int, long, float, double
		int var1 = 30;
		long var2 = 30L; // 30dms integer 타입
		float var3 = 3.008F; // 3.008은 double 타입인데 double이 공간이 더 큼
		double var4 = 3.008;
		...
		String str = "여러 글자는 이렇게 쓰세";
		
		// 3. char를 intdp 넣을 때
		char ch4 = 'a';
		int chi = ch4; // int가 더 범위가 넓으므로 가능
		// ch4 = chi;  //넓은 곳에서 좁은 곳으로는 자연스럽게 못 감
		u.p("3. ch4 = " + ch4);
		...
		u.p("5. My Name is " + myName + " 아닙니다.");
		
		
		// 6. String, int, double 
		String temp = "a" + 3; // trick 
		String temp2 = "3";
		String temp3 = "3.124455430988584884";
